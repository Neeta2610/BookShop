    ...
    $('#customerloginForm').on('click', function (e) {
        if (!e.isDefaultPrevented()) {
            ...
            $.ajax({
                    ...
                    data: {
                        loginPhone: $('#ShipPhoneNumber').val(),
    ...
    $(document).on('click', '.btn-round', function (e) {
        ...
        $.ajax({
                ...
                data: {
                    ...
                    productSchool:$(this).attr('data-val'),
                }
            })
            .done(function (msg) {
                updateCartDiv();
            ...
            if (cart) {
                ...
                Object.keys(cart).forEach(function (cartId) {
                    ...
                    if (item.productImage) {
                        productImage = `<img class="img-fluid" src="${item.productImage.path}" alt="${item.title} product image"></img>`;
                    }
